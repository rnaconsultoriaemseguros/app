...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="p-2 shadow-lg relative">
            ...
            <div className="flex flex-1 items-center sm:items-stretch sm:justify-start justify-end mr-2">
              <div className="flex flex-shrink-0 items-center">
                <Image
                  ...
                  src="/logo.png"
                  alt="R N A Consultoria em Seguros"
                  width={130}
                  height={60}
                  priority={true}
                />
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 hidden sm:block sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              <div className="relative ml-3">
                <div>
                  <Link
                    href={"/"}
                    className="text-[#211C1B] hover:bg-[#2B3E59] hover:text-white rounded-full px-3 mx-3 py-2 text-sm font-medium"
                  >
                    Home
                  </Link>
        ...
        >
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link
              href={"/"}
              className="text-[#211C1B] block rounded-md px-3 py-2 text-base font-medium"
            >
              Home
            </Link>
            ...
            <Link
              href={"/pages/about-us"}
              className="text-[#211C1B] hover:transition-all hover:bg-[#2B3E59] hover:text-white block rounded-md px-3 py-2 text-base font-medium"
            >
              Quem Somos
            </Link>
            ...
            <Link
              href={"/pages/contact"}
              className="bg-[#2B3E59] text-white hover:transition-all hover:bg-[#A5B9D3] hover:text-white block rounded-md px-3 py-2 text-base font-medium"
            >
              Entre em Contato
            </Link>
          </div>
